...
export class GameController {
  ...
  async createNewGame(
    ...
    const board = setAllowedTiles(newGame.board, newGame.gameState);
  ...
  async renderGame(
    ...
    const board = setAllowedTiles(foundGame.board, foundGame.gameState);
  ...
  async updateGame(
    ...
    if (foundGame.gameState.winner != null) {
      return sendResponse();
    }
    ...
    const { isGameWon } = checkIfGameWon(gameState, board, graph);
