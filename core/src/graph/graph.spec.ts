  ...
  it("should create a graph with all external tiles connected", () => {
    ...
    expect(serialized).toEqual({
      ...
      links: [
        ...
        { source: "F-green", target: "green-end", weight: 1 },
        ...
        { source: "B-red", target: "blue-end", weight: 1 },
        { source: "B-yellow", target: "blue-end", weight: 1 },
        { source: "A-blue", target: "blue-end", weight: 1 },
        { source: "A-blue", target: "yellow-end", weight: 1 },
        { source: "A-cyan", target: "yellow-end", weight: 1 },
        { source: "C-magenta", target: "yellow-end", weight: 1 },
        { source: "F-cyan", target: "yellow-end", weight: 1 },
        { source: "F-cyan", target: "green-end", weight: 1 },
        { source: "D-green", target: "green-end", weight: 1 },
        { source: "F-yellow", target: "green-end", weight: 1 },
      ],
    });
  });
