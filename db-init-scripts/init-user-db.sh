...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
  ...
  ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT UPDATE ON TABLES TO $POSTGREST_ROLE;
  ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT INSERT ON TABLES TO $POSTGREST_ROLE;
  ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT DELETE ON TABLES TO $POSTGREST_ROLE;
EOSQL